  ...
  return (
     <main>
        <div className="w-full py-5 md:py-10 max-w-[1440px] px-5 mx-auto">
            <button onClick={() => router.history.go(-1)} className='px-6  cursor-pointer transition duration-300 hover:opacity-80 inline-flex items-center gap-2 py-2.5 bg-gray-1400 rounded-full text-base font-semibold text-black-1000'>
                ...
                <div className="w-full flex gap-6 md:gap-10 xl:flex-row flex-col">
                    <div className="flex-1 max-w-full xl:max-w-[450px]">
                        ...
                        <div className="w-full pb-7 pt-6 md:py-10 hidden md:flex items-center justify-between">
                            <div className="flex items-center gap-3 2xl:gap-5">
                                ...
                                <h3 className='md:text-[28px] text-lg font-bold text-black-1000 font-inter'>{raffle?.userName}</h3>
                            </div>
                    ...
                    <div className="flex-1">
                        <div className="w-full">
                            ...
                            <h1 className='md:text-[28px] text-xl font-inter md:mt-6 my-5 md:mb-5 font-bold text-black-100'>{raffle?.tokenSymbol}</h1>
                          ...
                          <div className="w-full flex items-center justify-between p-2 rounded-[10px] bg-primary-color">
                            ...
                            <h4 className='text-base text-white font-semibold font-inter'>Won with 2 Ticket(s)</h4>
                            ...
                            <h4 className="sm:text-base text-xs text-white font-semibold font-inter px-4">
                              Raffle winner
                                ...
                                <div className="w-full mt-6">
                                  ...
                                  <div className="w-full items-center grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-5">
                                    <QuantityBox/>
                                    ...
                                    <div className="w-full mb-5">
                                      <button className='border transition duration-300 hover:bg-primary-color hover:border-primary-color cursor-pointer w-full text-base font-semibold border-black-1000 rounded-full h-[56px] flex items-center justify-center'>
                                        Add To Cart
                                      </button>
                                    </div>
