        ...
        <div className="w-full flex items-center justify-between gap-5 lg:gap-10 flex-wrap">
          ...
          <ul className="flex items-center md:gap-5 gap-1.5 xs:gap-3">
            {["Featured", "All Raffles", "Past Raffles"].map((f, index) => (
              <li key={index}>
                <button onClick={() => setFilter(f)} className={`md:text-base text-sm cursor-pointer font-inter font-medium transition duration-300 hover:bg-primary-color text-black-1000 rounded-full py-2.5 md:py-3.5 px-4
