      ...
      <div className="bg-white shadow-lg rounded-md p-2">
        ...
        {payload.map((p: any) => (
          <p key={p.dataKey} className="text-black-1000 text-sm font-inter font-semibold">
            {p.dataKey === "ticketsSold" ? "Tickets Sold: " : "Transactions: "} {p.value}
          </p>
        ))}
      </div>
    )
...
export default function PurchasesChart({ data, isLoading }: PurchasesChartProps) {
      ...
      <div className="flex lg:flex-nowrap flex-wrap lg:gap-0 gap-5 bg-gray-1300 border-b border-gray-1100 py-6 px-5 items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">
            {totalTicketsSold} tickets • {totalTransactions} transactions
          </p>
        </div>
        ...
        {isLoading ? (
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Bar dataKey="ticketsSold" fill="#f08409" radius={[0, 0, 0, 0]} barSize={16} />
